function idx = HAC3B(X, k, visualize2D)
...
% clusters to be the complete-link inter-cluster distance.
%
% INPUTS
...
%           point X(i, :) has been assigned to cluster c.
    ...
    % The complete-link distances between all of the clusters. Initially,
    ...
    while num_clusters > k
        ...
        % Find the pair of clusters that are closest together by complete-link.
        ...
        % its cluster size to 0 and setting the complete-link distance
        ...
        % of each cluster (complete-link method).
